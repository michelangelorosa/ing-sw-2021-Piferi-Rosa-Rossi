...
/**
 * FaithTrackCheat Class is a special Action to be used when Cheat Mode is enabled to give Faith Points to the player.
 */
public class FaithTrackCheat extends Action {

    /**
     * Constructor for FaithTrackCheat Class.
     */
