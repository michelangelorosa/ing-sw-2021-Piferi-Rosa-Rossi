...
/**
 * ServerMessageHandlerDebugger Class defines data and methods used to print debugging information inside a ServerMessageHandler Object.
 * All attributes are static because they are shared between all Debuggers of this type.
 * <p><b>Attributes:</b></p>
 * <ul>
 *     <li>String "SMH": contains ANSI escape codes and text to specify which Debugger is being used</li>
 *     <li>boolean "active": used to activate or deactivate a specific type of Debugger</li>
 * </ul>
 * @author redrick99
 */
public class ServerMessageHandlerDebugger extends Debugger {
    private static final String SMH = ANSIDebug.SERVER_MESSAGE_HANDLER + "[SERVER M-HANDLER]  ";
    private static boolean active = true;

    /**
     * Protected Constructor to be accessed only by the DebuggerFactory Class.
     */
    protected ServerMessageHandlerDebugger() {
    ...
    public void printDebug(String string) {
        if(allActive && active)
            System.out.println(SMH + string + R);
    }
    ...
    public static void setActive(boolean active) {
        ServerMessageHandlerDebugger.active = active;
    }
}
