...
/**
 * ControllerDebugger Class defines data and methods used to print debugging information inside a Controller Object.
 ...
 * @author redrick99
 */
public class ControllerDebugger extends Debugger{
    private static final String C = ANSIDebug.CONTROLLER + "[CONTROLLER]        ";
    private static boolean active = true;

    /**
     * Protected Constructor to be accessed only by the DebuggerFactory Class.
     */
    protected ControllerDebugger() {
    ...
    public static void setActive(boolean active) {
        ControllerDebugger.active = active;
    }
}
