...
/**
 * ClientDebugger Class defines data and methods used to print debugging information inside a Client Object.
 ...
 * @author redrick99
 */
public class ClientDebugger extends Debugger {
    private static final String C = ANSIDebug.CLIENT + "[CLIENT]            ";
    private static boolean active = true;

    /**
     * Protected Constructor to be accessed only by the DebuggerFactory Class.
     */
    protected ClientDebugger() {
