...
/**
 * CliControllerDebugger Class defines data and methods used to print debugging information inside a CliController Object.
 ...
 * @author redrick99
 */
public class CliControllerDebugger extends Debugger{
    private static final String CC = ANSIDebug.CLI_CONTROLLER + "[CLI CONTROLLER]    ";
    private static boolean active = true;

    /**
     * Protected Constructor to be accessed only by the DebuggerFactory Class.
     */
    protected CliControllerDebugger() {
    ...
    public static void setActive(boolean active) {
        CliControllerDebugger.active = active;
    }
}
