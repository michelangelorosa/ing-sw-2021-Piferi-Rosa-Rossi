...
public class LeaderCardJSONAbility {
    ...
    public LeaderCardJSONAbility(int leaderAbility, int cardId, int victoryPoints, int needsShields, int needsServants, int needsCoins, int needsStones, int needsBlueCardLv1, int needsBlueCardLv2, int needsBlueCardLv3, int needsPurpleCardLv1, int needsPurpleCardLv2, int needsPurpleCardLv3, int needsYellowCardLv1, int needsYellowCardLv2, int needsYellowCardLv3, int needsGreenCardLv1, int needsGreenCardLv2, int needsGreenCardLv3, int discountShields, int discountServants, int discountCoins, int discountStones, int depotType, int marbleConversion, int inputShields, int inputServants, int inputCoins, int inputStones, int jollyOut, int outputFaith) {
        ...
        this.needsPurpleCardLv1 = needsPurpleCardLv1;
        this.needsPurpleCardLv2 = needsPurpleCardLv2;
        this.needsPurpleCardLv3 = needsPurpleCardLv3;
        this.needsYellowCardLv1 = needsYellowCardLv1;
        this.needsYellowCardLv2 = needsYellowCardLv2;
        this.needsYellowCardLv3 = needsYellowCardLv3;
        this.needsGreenCardLv1 = needsGreenCardLv1;
        this.needsGreenCardLv2 = needsGreenCardLv2;
        this.needsGreenCardLv3 = needsGreenCardLv3;
        this.discountShields = discountShields;
        this.discountServants = discountServants;
        this.discountCoins = discountCoins;
        this.discountStones = discountStones;
        this.depotType = depotType;
        this.marbleConversion = marbleConversion;
