...
public class SwitchDepotTest {
    ...
    public void doActionTest(){
        ...
        assertEquals(ActionType.SWITCH_DEPOT, messageToClient.getPossibleActions().get(2));
        assertEquals(ActionType.END_MARKET, messageToClient.getPossibleActions().get(3));
        assertEquals(game.getCurrentPlayer().getBoard().getResourceManager().getWarehouse().getWarehouseDepots()[1].getResourceType(), ((SwitchDepotMessage)messageToClient).getWarehouse().getWarehouseDepots()[1].getResourceType());
        ...
        assertEquals(ActionType.SWITCH_DEPOT, messageToClient.getPossibleActions().get(2));
        assertEquals(ActionType.END_MARKET, messageToClient.getPossibleActions().get(3));
        assertEquals(game.getCurrentPlayer().getBoard().getResourceManager().getWarehouse().isFull(), ((SwitchDepotMessage)messageToClient).getWarehouse().isFull());
